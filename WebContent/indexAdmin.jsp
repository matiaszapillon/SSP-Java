...
<body id="page-top">
	...
	<a class="navbar-brand mr-1" href="indexAdmin.jsp">Menu
		Administrador</a> <!-- Navbar Search -->
	<form
		...
		<ul class="sidebar navbar-nav">
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					...
					<a class="dropdown-item">Insumos</a> <a class="dropdown-item">Etapas</a>
					<a class="dropdown-item" href="activityManagmentServlet">Actividades</a>
					<a class="dropdown-item">Empleados</a> <a class="dropdown-item"
						href="clientsManagmentServlet">Clientes</a> <a
						class="dropdown-item" href="userManagmentServlet">Usuarios</a>
				</div></li>
			<li class="nav-item"><a class="nav-link" href="reportsServlet">
					<i class="fas fa-fw fa-chart-area"></i> <span>Reportes</span>
			</a></li>
			<li class="nav-item"><a class="nav-link"
				href="projectManagmentServlet"> <i
					class="fas fa-project-diagram"></i> <span>Gestion Proyectos</span>
			</a></li>
		</ul>
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="jumbotron text-center">
					...
					<hr class="my-4">
					<p>Este trabajo presenta conocimientos basicos del lenguaje de
						programacion Java, orientando a cumplir los requisitos necesarios
						para aprobar la materia de dicho nombre dictada en la Universidad
						Tecnologica Nacional Regional Rosario.</p>
					<p>Este trabajo contiene contenido de Java, HTML, CSS y
						Bootstrap 4.</p>
					<button class="btn btn-primary" type="button"
						data-toggle="collapse" data-target="#collapseAlumnos"
				...
				<!-- Fila de Logos -->
				<div class="row m-3">
					<img src="images/java-logo.jpg" class="rounded mx-auto"
						alt="Logo Java"> <img src="images/utn-logo.png"
						class="rounded mx-auto" alt="Logo UTN"> <img
						src="images/bootstrap-logo.png" class="rounded mx-auto"
						alt="Logo Bootstrap">
				</div>
			</div>
		</div>
