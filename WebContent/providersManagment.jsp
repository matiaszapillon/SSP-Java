    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <!-- Formulario -->
                <form class="" action="providersManagmentServlet" method="POST" onsubmit="return validateForm()">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                        <%
                                                    ArrayList<Provider> providers = (ArrayList<Provider>)request.getAttribute("proveedores");
                                                        for(Provider prov : providers){
                                                        %>
                                        <tr>
                                            <td>
                                                <input type="radio" name="radioABM" value="<%= prov.getId() %>">
                                            </td>
                                            <td>
                                                <%= prov.getId() %>
                                            </td>
                                            <td>
                                                <%= prov.getBusiness_name() %>
                                            </td>
                                            <td>
                                                <%= prov.getName() %>
                                            </td>
                        ...
                        <div class="card-footer small text-muted">
                            <button type="submit" name="addButton" class="btn btn-success" id="addButton"
                                onclick="setHiddenValue(this.id)"><i class="fas fa-plus"></i></button>
                            <button type="submit" name="editButton" class="btn btn-info" id="editButton"
                                onclick="setHiddenValue(this.id)"><i class="fas fa-edit"></i></button>
                            <button type="submit" name="deleteButton" class="btn btn-danger float-right"
                                id="deleteButton" onclick="setHiddenValue(this.id)"><i
