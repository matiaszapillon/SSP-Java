              ...
              <form method="post" action="projectManagmentServlet">
                ...
                <div class="form-group">
                  ...
                  <button type="submit" id="<%= p.getId() %>" name="buttonProject" 
	                        ...
	                        %> 
	                        class="list-group-item list-group-item-action btn btn-light active" <% } else { %>
                    		class="list-group-item list-group-item-action btn btn-light" <% } } else { %> 
                    		class="list-group-item list-group-item-action btn btn-light" <%	} %>
                    		value="<%= p.getId() %>">
                    <%= p.getName() %>
                  </button>
                  <% } %>
              ...
              <form method="post" action="projectManagmentServlet">
                ...
                <div class="row">
                  <div class="form-group col-2">
                    <label>ID</label>
                    <input class="form-control" type="text" name="idProjectName" readonly
                      <% if(clickedProject != null) { %> value="<%= clickedProject.getId() %>" <% } %>>
                  </div>
                  <div class="form-group col">
                    <label> Descripcion </label>
                    <input class="form-control" type="text" name="descriptionName" readonly
                      <% if(clickedProject != null) { %> value="<%=clickedProject.getDescription() %><% } %>">
                  </div>
                  <div class="form-group col">
                ...
                <div class="row">
                  <div class="form-group col">
                    <label>Cliente</label>
                    <input class="form-control" type="text" name="clientName" readonly
                      <% if(clickedProject != null) { if(clickedProject.getClient() != null) { %>
                      value="<%= clickedProject.getClient().getBusiness_name() %>" <% } else { %> value=" - " <% } } %>>
                  </div>
                  <div class="form-group col">
                    <label>CUIT / CUIL</label>
                    <input class="form-control" type="text" name="CUIT_CUILName" readonly
                      <% if (clickedProject != null) { if(clickedProject.getClient() != null) {%>
                ...
                <div class="row">
                  ...
                  <div class="form-group col">
                    ...
                    <input class="form-control" type="text" name="currentStageName" readonly <% if (clickedProject != null) {
                            	if(clickedProject.getCurrentStage() != null) { %>
                      value="<%= clickedProject.getCurrentStage().getName() %>" <% } else { %> value=" - " <% } } %>>
                  </div>
                </div>
                <div class="form-group">
                  <button type="submit" class="btn btn-outline-info" name="detallesName" data-toggle="tooltip"
                    data-placement="bottom" title="More Details" <% if(clickedProject == null) { %> disabled <% } %>><i
                      class="fas fa-info-circle"></i>
                  </button>
                  <button type="submit" class="btn btn-outline-danger float-right" name="btnDeleteProject"
                    data-toggle="tooltip" data-placement="bottom" title="Eliminar Proyecto"
                    <% if(clickedProject == null) { %> disabled <% } %>><i class="fas fa-trash"></i>
                  </button>
                </div>
              </form>
            </div>
